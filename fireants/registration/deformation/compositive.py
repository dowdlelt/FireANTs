...
class CompositiveWarp(nn.Module, AbstractDeformation):
    ...
    def __init__(self, fixed_images: BatchedImages, moving_images: BatchedImages,
        ...
        # propagate restrict_deformation to optimizer
        if oparams.get('restrict_deformation') is None and restrict_deformation is not None:
            oparams['restrict_deformation'] = restrict_deformation
        # add optimizer
