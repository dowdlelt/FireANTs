...
class CompositiveWarp(nn.Module, AbstractDeformation):
    ...
    def __init__(
        ...
        smoothing_warp_sigma: float = 0.5,
        freeform: bool = False,
    ) -> None:
        super().__init__()
    ...
    def get_inverse_warp(self):
        raise NotImplementedError(
            "Inverse warp not implemented for compositive warp, use `compositive_warp_inverse` from warputils.py instead"
        )
